	...
	if(isset($_GET['ref']))
	{
		switch($_GET['ref'])
		{
			case 'registersqlerror':
				$feedback_msg='A problem occured during the registration. Sorry for the inconvinience. Please try again.';
				break;
			...
			case 'registersuccess':
					$feedback_msg='Event Registration Successful!';
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top">
 							<table border="0" cellpadding="2" cellpadding="2" width="100%">
                            	<tr><td colspan="2"><span  class="content-placer">home | robotics registration</span><br /><br /></td></tr>
                                <tr><td colspan="2"><span class="content-header">Robotics Event Registration</span> | <a href="tf-roboreg-list.php" class="text-body-link">See List</a><br /><br /></td></tr>
                                <form name="form_register" method="post" action="tf-roboreg-backend.php">
                               ...
                               <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
                                ...
                                <tr><td>Group Name</td><td><input class="form-items" id="register_groupname" type="text" name="groupname" maxlength="128" value="" size="50" /></td></tr>
                                ...
                                <tr><td>Email ID</td><td><input class="form-items" id="register_emailid" type="text" name="emailid" maxlength="256" value="" size="50" /></td></tr>
