<?php
	...
	define("__SQL_DBNAME__","ENTER_DATABASE_NAME_HERE",true);							//MySQL Database name for the site
	define("__SQL_TABLE_PREFIX__","sristi2010_",true);						//MySQL Table name prefix for the site db
	
	//Twitter Account access
	define("__TWITTER_USERNAME__","TWITTER)USERNAME_HERE",true);					//Server Hostname to MySQL Server
	define("__TWITTER_PASSWORD__","TWITTER_PASSWORD_HERE",true);						//MySQL System Username for the site
	
	//Site Specification CONSTANTS
	define("__SITE_ADMINEMAIL__","sristi.cfi@gmail.com",true);			//Site Admin's Email Address, where error-reports, feedback etc. will go
	define("__SITE_WEBADDRESS__","http://sristi.org.in/",true);				//Absolute website address, ** with trailing / **
	...
	define("__PAGE_TITLE_PREFIX__","Sristi 2010 - ",true);					//Prefix - Page title formatting
